...
from auditor import dispatcher #BAN_STICKER
from auditor.modules.disable import DisableAbleCommandHandler
from auditor.modules.helper_funcs.chat_status import is_user_admin, bot_admin, user_admin_no_reply, user_admin, \
    can_restrict
from auditor.modules.helper_funcs.extraction import extract_text, extract_user_and_text, extract_user
from auditor.modules.helper_funcs.filters import CustomFilters
from auditor.modules.helper_funcs.misc import split_message
from auditor.modules.helper_funcs.string_handling import split_quotes
from auditor.modules.helper_funcs.alternate import typing_action
from auditor.modules.log_channel import loggable
from auditor.modules.sql import warns_sql as sql
...
def warn(user: User, chat: Chat, reason: str, message: Message, warner: User = None) -> str:
    if is_user_admin(chat, user.id):	
        message.reply_text("Damn , He is admin ")	
        return ""   
