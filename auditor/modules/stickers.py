...
__help__ = """
Kanging Stickers made easy with stickers module! You can kang both normal and animated sticker
...
*#TEXT_TO_STICKER*
- /sticklet <text> : gives you the sticker of the text
NOTE - In group only group admins are allowd , others simple can use in bot's pm

*#QUOTLY_CAPTURE*
- /click : reply the command to someone's mssg kek
NOTE - In group only group admins are allowd , others simple can use in bot's pm
