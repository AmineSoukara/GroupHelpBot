...
from auditor.modules.helper_funcs.chat_status import bot_admin, can_promote, user_admin, can_pin
from auditor.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from auditor.modules.helper_funcs.admin_rights import user_can_pin, user_can_promote, user_can_changeinfo
...
*Admin only:*
 ...
 × /users: get list of the users in the chat
 × /removebotkeyboard: to remove this **/** nasty keyboard
...
*#DELETED_ACCOUUNTS*
 × /deleted: finds number of deleted accounts in the chat
 × /deleted clean : remove deleted accounts from the chat
 
*#FORCE_CHANNEL_MEMBERS*
 × /force: find about the force member function
 × /forcehelp : for help
"""
