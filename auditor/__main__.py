...
from auditor import dispatcher, updater, TOKEN, WEBHOOK, CERT_PATH, PORT, URL, LOGGER, \
     BLACKLIST_CHATS, WHITELIST_CHATS
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from auditor.modules import ALL_MODULES
from auditor.modules.purge import client
from auditor.modules.helper_funcs.chat_status import is_user_admin
from auditor.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("auditor.modules." + module_name)
...
def start(update, context):
    if update.effective_chat.type == "private":
        ...
        if len(args) >= 1:
            ...
            "https://telegra.ph/file/59ee44cd72d94e7bb50a6.jpg",
        ...
        update.effective_message.reply_text("Heya :) PM me if you have any questions on how to use me!",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="Get Started 👻",
